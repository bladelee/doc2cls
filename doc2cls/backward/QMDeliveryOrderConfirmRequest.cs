...
[Serializable]
[XmlRoot("request")]
public class QMDeliveryOrderConfirmRequest
{

[XmlElement("deliveryOrder", typeof(QMDeliveryOrderConfirmRequestDeliveryOrder))]
public QMDeliveryOrderConfirmRequestDeliveryOrder DeliveryOrder {get; set;}

[XmlArray("packages")]
[XmlArrayItem("package", typeof(QMDeliveryOrderConfirmRequestPackage))]
public QMDeliveryOrderConfirmRequestPackage[] Packages {get; set;}

[XmlArray("orderLines")]
[XmlArrayItem("orderLine", typeof(QMDeliveryOrderConfirmRequestOrderLine))]
public QMDeliveryOrderConfirmRequestOrderLine[] OrderLines {get; set;}
}
[Serializable]
public class QMDeliveryOrderConfirmRequestDeliveryOrder
{
/// <summary>
/// 出库单号
/// </summary>
...
[XmlArray("invoices")]
[XmlArrayItem("invoice", typeof(QMDeliveryOrderConfirmRequestDeliveryOrderInvoice))]
public QMDeliveryOrderConfirmRequestDeliveryOrderInvoice[] Invoices {get; set;}
}
[Serializable]
public class QMDeliveryOrderConfirmRequestDeliveryOrderInvoice
{
/// <summary>
/// 发票抬头
/// </summary>
...
[XmlElement("detail", typeof(QMDeliveryOrderConfirmRequestDeliveryOrderInvoiceDetail))]
public QMDeliveryOrderConfirmRequestDeliveryOrderInvoiceDetail Detail {get; set;}
/// <summary>
/// 发票代码,纳税企业的标识
/// </summary>
...
[Serializable]
public class QMDeliveryOrderConfirmRequestDeliveryOrderInvoiceDetail
{

[XmlArray("items")]
[XmlArrayItem("item", typeof(QMDeliveryOrderConfirmRequestDeliveryOrderInvoiceDetailItem))]
public QMDeliveryOrderConfirmRequestDeliveryOrderInvoiceDetailItem[] Items {get; set;}
}
[Serializable]
public class QMDeliveryOrderConfirmRequestDeliveryOrderInvoiceDetailItem
{
/// <summary>
/// 商品名称
/// </summary>
...
[Serializable]
public class QMDeliveryOrderConfirmRequestPackage
{
/// <summary>
...
[XmlArrayItem("packageMaterial", typeof(QMDeliveryOrderConfirmRequestPackagePackageMaterial))]
public QMDeliveryOrderConfirmRequestPackagePackageMaterial[] PackageMaterialList {get; set;}

[XmlArray("items")]
[XmlArrayItem("item", typeof(QMDeliveryOrderConfirmRequestPackageItem))]
public QMDeliveryOrderConfirmRequestPackageItem[] Items {get; set;}
}
[Serializable]
public class QMDeliveryOrderConfirmRequestPackagePackageMaterial
{
/// <summary>
/// 包材型号
/// </summary>
...
[Serializable]
public class QMDeliveryOrderConfirmRequestPackageItem
{
/// <summary>
/// 商品编码
/// </summary>
...
[Serializable]
public class QMDeliveryOrderConfirmRequestOrderLine
{
/// <summary>
/// 单据行号
/// </summary>
...
[XmlArray("batchs")]
[XmlArrayItem("batch", typeof(QMDeliveryOrderConfirmRequestOrderLineBatch))]
public QMDeliveryOrderConfirmRequestOrderLineBatch[] Batchs {get; set;}
/// <summary>
...
[Serializable]
public class QMDeliveryOrderConfirmRequestOrderLineBatch
{
/// <summary>
/// 批次编号
/// </summary>
