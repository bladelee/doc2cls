...
[Serializable]
[XmlRoot("request")]
public class QMDeliveryOrderBatchCreateRequest
{

[XmlArray("orders")]
[XmlArrayItem("order", typeof(QMDeliveryOrderBatchCreateRequestOrder))]
public QMDeliveryOrderBatchCreateRequestOrder[] Orders {get; set;}
}
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrder
{

[XmlElement("deliveryOrder", typeof(QMDeliveryOrderBatchCreateRequestOrderDeliveryOrder))]
public QMDeliveryOrderBatchCreateRequestOrderDeliveryOrder DeliveryOrder {get; set;}

[XmlArray("orderLines")]
[XmlArrayItem("orderLine", typeof(QMDeliveryOrderBatchCreateRequestOrderOrderLine))]
public QMDeliveryOrderBatchCreateRequestOrderOrderLine[] OrderLines {get; set;}
}
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderDeliveryOrder
{
/// <summary>
/// 出库单号
/// </summary>
...
[XmlElement("deliveryRequirements", typeof(QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderDeliveryRequirements))]
public QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderDeliveryRequirements DeliveryRequirements {get; set;}

[XmlElement("senderInfo", typeof(QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderSenderInfo))]
public QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderSenderInfo SenderInfo {get; set;}

[XmlElement("receiverInfo", typeof(QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderReceiverInfo))]
public QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderReceiverInfo ReceiverInfo {get; set;}
/// <summary>
/// 是否紧急, Y/N, 默认为N
/// </summary>
[MaxLength(1)]
...
[XmlArray("invoices")]
[XmlArrayItem("invoice", typeof(QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoice))]
public QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoice[] Invoices {get; set;}
/// <summary>
/// 是否需要保险, Y/N, 默认为N
/// </summary>
[MaxLength(1)]
...
[XmlElement("insurance", typeof(QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInsurance))]
public QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInsurance Insurance {get; set;}
/// <summary>
/// 买家留言
/// </summary>
[MaxLength(500)]
...
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderDeliveryRequirements
{
/// <summary>
...
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderSenderInfo
{
/// <summary>
/// 公司名称
/// </summary>
...
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderReceiverInfo
{
/// <summary>
/// 公司名称
/// </summary>
...
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoice
{
/// <summary>
...
[XmlElement("detail", typeof(QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoiceDetail))]
public QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoiceDetail Detail {get; set;}
}
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoiceDetail
{

[XmlArray("items")]
[XmlArrayItem("item", typeof(QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoiceDetailItem))]
public QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoiceDetailItem[] Items {get; set;}
}
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInvoiceDetailItem
{
/// <summary>
/// 商品名称
/// </summary>
...
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderDeliveryOrderInsurance
{
/// <summary>
/// 保险类型
/// </summary>
...
[Serializable]
public class QMDeliveryOrderBatchCreateRequestOrderOrderLine
{
/// <summary>
/// 单据行号
/// </summary>
